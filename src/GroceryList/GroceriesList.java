...
public class GroceriesList {
    ...
    public static HashMap<String, ArrayList<GroceryItems>> catList = new HashMap<>();
...
//    HashMap<String, Double> gList = new HashMap<>();
    ...
    public static void groceryMenu2() {
        ...
        if (valid) {
            ...
            GroceryItems item = new GroceryItems(grocery, amount);
        ...
        if(cont){
            ...
            for (String key : keyArray) {
                ...
                for (GroceryItems list  : catList.get(key)){
